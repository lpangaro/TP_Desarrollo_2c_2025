        ...
        <div className='container'>
            ...
            {user && user._id === id && (
                <div className='d-flex gap-1'>
                    <button className='boton' onClick={() => { setMostrar("productos"); setAbrirFormulario(false) }}>Productos</button>
                    <button className='boton' onClick={traerPedidos}>Pedidos</button>
                    <button className="boton" onClick={() => setAbrirFormulario(true)}>Agregar producto</button>
